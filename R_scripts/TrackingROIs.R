...
setwd("G:/My Drive/social_dark_analysis")
...
setwd(dir<-"G:/My Drive/social_dark_analysis")#sets working directory (setwd), and new variable (dir) corresponding to parent directory
...
CombinedInfo<-AllFoldersList[[10]]#pull dataframe corresponding to particular day/trial
...
#Total movement
plot(1,type="n", main = "T002 Day 1", xlab="horizontal coordinates", ylab="vertical coordinates",ylim=c(0,1080),xlim=c(0,1400))
...
image(allheat$x, allheat$y, allheat$z, col = colfunc(50), axes = TRUE,ylab="Vertical coordinates",
      xlab="Horizontal coordinates",main="T002 Day 1 Activity")
...
image(a1heat,ylim=c(0,1080),xlim=c(0,1400),col = colfunc(50), main = "T002 Day 1")
par(new = TRUE)
