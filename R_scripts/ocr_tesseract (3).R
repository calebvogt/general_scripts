...
## TO-DO LIST:
# 1. Need to look into making the cropped image bigger.follow the guidelines to make OCR detection better. https://cran.r-project.org/web/packages/tesseract/vignettes/intro.html
...
# CHECK THAT ALL VIDEOS ARE 1080P. IF VIDEOS ARE LOW RESOLUTION, SHIFT TO DIFFERENT FOLDER. RERUN CODE WITH CROP PARAMETERS ADJUSTED FOR LOW RESOLUTION FOOTAGE. 
wd <- setwd("Z:/7_Liddell_2020/TRIALS/T002/RCNN")
system("cd /d Z:/7_Liddell_2020/TRIALS/T002/RCNN")
getwd()
