...
## testing
wd <- setwd("Y:/Data/FieldProject/video_behavior_sleap/3_liddell_bucket/simba/project_folder/csv/input_csv")
dir.create("proc")
filenames <- list.files(wd,pattern="*.csv") ## these should be csvs resulting from recent import of .h5 files into simba
aa=2
